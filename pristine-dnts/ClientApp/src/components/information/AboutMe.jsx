...
const UglyGuy = 'uglyguy.jpg';
const WechatLogo = 'wechat-logo.png';
const GithubLogo = 'github-logo.png';
const ResumeFile = 'Hanzhang_ZENG_resume.pdf';
    ...
    return (
      <div className={this.props.classes.contactDetailDiv}>
        ...
        <IconButton aria-label="wechat" onClick={this.handleWechat}>
          <img alt="WeChat" src={WechatLogo} width={'24'} />
        </IconButton>
        <IconButton aria-label="github" onClick={this.handleGithub}>
          <img alt="GitHub" src={GithubLogo} width={'24'} />
        </IconButton>
      </div>
    );
  }
    ...
    return (
      <div className={this.props.classes.aboutDiv}>
        ...
        <Typography variant='body1' className={this.props.classes.typoGap}>
          ...
          If you are interested in how I actually achieve it, please follow the <a target="_blank" href="https://github.com/RogerTsang/Pristine" rel="noopener noreferrer">link</a>.
        </Typography>
